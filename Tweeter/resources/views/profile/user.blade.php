        ...
        <div class="row align-items-center">
            <div class="col">
                <div>
                    ...
                    <img class="img-thumbnail" src="/{{$user[0]->profile_photo}}" alt="profile photo">
                        @endif
                        <p class="h3 m-3">@ {{$user[0]->name}}<img class="img-fluid" style="width: 30px;" src="/logo.png" alt="The Great Ironic Eagle"></p>
